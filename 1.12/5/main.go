...
в порядке ввода в массив из 10 элементов.
Тип чисел, входящих в массив, должен соответствовать минимально возможному целому беззнаковому типу.
...
func main() {
	...
	for i := 0; i < len(ind); i += 2 {
		workArray[ind[i]], workArray[ind[i+1]] = workArray[ind[i+1]], workArray[ind[i]]
	}
